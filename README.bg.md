...
потребителя. Трябва да се отбележи също така, че отдела за поддръжка на клиенти на EA тихомълком затвори заявка за
докладване и поискване на информация относно този проблем, което дава на потребителите още по-малко причини да се
доверяват на компанията и нейния софтуер. Този проблем беше открит още през [2021 г.][eabs-reddit-1], но [все още не е
отстранен][eabs-reddit-2].
